...
repeat(ds_height) {
	...
	draw_text_color(1100, 200, "No has dormido, te ha aumnetado el cansancio", c_white, c_white, c_white, c_white, 1);
	draw_text_color(ltx + xo + 100, lty, ds_grid[# 0, yy], c, c, c, c, 1);
	yy++;
}
